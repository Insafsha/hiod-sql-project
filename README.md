...
построение схемы БД, генерацию реалистичных данных, аналитические SQL-запросы и визуализацию ключевых метрик средствами Python, создание интерактивного дашборда в Metabase.
